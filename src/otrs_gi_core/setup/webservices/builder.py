...
from otrs_gi_core.setup.webservices.operations import SUPPORTED_OPERATION_SPECS
from otrs_gi_core.setup.webservices.webservice_models import OperationSpec
