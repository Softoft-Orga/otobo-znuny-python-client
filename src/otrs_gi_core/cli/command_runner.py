...
from otrs_gi_core.cli.command_models import CmdResult
...
class ConsoleCommandRunner:
    ...
    def from_docker(cls, container: str = "otobo-web-1",
                    console_path="./bin/otobo.Console.pl") -> ConsoleCommandRunner:
        return cls(["docker", "exec", container], console_path)

    @classmethod
    def from_local(cls, console_path="/opt/otobo/bin/otobo.Console.pl") -> ConsoleCommandRunner:
