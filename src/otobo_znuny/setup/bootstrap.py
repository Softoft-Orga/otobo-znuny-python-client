...
from otobo_znuny.cli.interface import OtoboCommandRunner, OtoboConsole
from .webservices.generator import WebServiceGenerator
...
def setup_otobo_system(env: SystemEnvironment | DockerEnvironment, config: SetupConfig) -> None:
    ...
    operation_urls = OperationUrlMap(
    ...
    typer.echo(f"Username: webservice")
...
def quick_setup(
    ...
    webservices_dir: Path = typer.Option(Path("/opt/otobo/var/webservices"), help="Directory for web service files"),
    ...
    config = SetupConfig(
        ...
        enabled_operations=[TicketOperation.GET, TicketOperation.SEARCH, TicketOperation.CREATE, TicketOperation.UPDATE],
